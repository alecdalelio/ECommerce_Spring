...
public class MainController {
    ...
    public void addNew() {
        ...
        if (allProducts.isEmpty()) {
            ...
            newProducts.add(new Product(4, 1500.00, "Apple MacBook Pro", "MacBook Pro", "Apple", "computer",
                    "images/apple_mlh32ll_a_15_4_macbook_pro_with_1293726.jpg"));

            newProducts.add(new Product(3, 1000.00, "C7 ST Desktop Front Edit", "Desktop", "Dell", "computer",
                    "images/C7_ST_Desktop_Front.jpg"));

            newProducts.add(new Product(12, 800.00, "New iPhone 8, Silver", "IPhone 8", "Apple", "phone",
                    "images/iphone8-silver-select-2017.jpg"));

            newProducts.add(new Product(7, 700.00, "New iPhone", "IPhone", "IPhone", "phone",
